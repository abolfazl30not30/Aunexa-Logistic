    ...
    return (
        <>
            <div className="w-[80%] md:w-[50%]">
                ...
                <div>
                <a href={`https://auth.aunexa.net/oauth2/authorize?response_type=code&client_id=client1&scope=openid&redirect_uri=http://localhost:3000/redirect&code_challenge=${codeChallenge}&code_challenge_method=S256`}  className="block text-center w-full rounded-[0.5rem] py-3 bg-mainRed text-white font-bold text-mainRed hover:opacity-80 ">ورود
                    </a>
                </div>
            </div>
        </>
