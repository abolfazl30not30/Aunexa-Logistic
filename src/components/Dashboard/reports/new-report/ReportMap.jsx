        ...
        <>
            <div className="report-map">
                <MapContainer key={new Date().getTime()} center={center} zoom={ZOOM_LEVEL}>
                    ...
                    {
                        locationArray.length && (<CircleMarker radius={8} center={locationArray[0]} fillColor="navy"/>)
                    }

                    {
                        locationArray.length && (<CircleMarker radius={8} center={locationArray[locationArray.length - 1]} fillColor="navy"/>)
                    }
