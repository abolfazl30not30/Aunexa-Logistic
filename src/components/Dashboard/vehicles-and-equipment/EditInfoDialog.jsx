...
export default function EditInfoDialog(props) {
    ...
    useEffect(()=>{
        ...
        formik.setValues({
            ...
            gpsModel:editInfoObj.gpsModel,
            imei:editInfoObj.imei,
            password:editInfoObj.password,
            phoneNumber1:editInfoObj.phoneNumber1,
            phoneNumber2:editInfoObj?.phoneNumber2,
