                ...
                <DialogContent>
                    <DialogContentText style={{ fontFamily: "__fonts_2f4189,__fonts_Fallback_2f4189" }}>
                        ...
                        <div className=" flex md:hidden  justify-center mt-5 gap-3">
                            <button onClick={()=>{props.handleOpenRejection(props.moreInfoTarget);props.handleCloseMoreInfo()}} className="px-6 py-2 text-[0.8rem] text-mainRed border border-mainRed rounded hover:bg-mainPurple hover:text-white">
                                رد
                            </button>
