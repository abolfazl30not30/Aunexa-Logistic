                                            ...
                                            <details
                                                ...
                                                <summary className="flex items-center justify-between gap-2  font-medium marker:content-none hover:cursor-pointer px-2">
                                                    <div className="flex items-center py-1 gap-3">
                                                        ...
                                                        <div className="text-textGray  text-[0.9rem] text-sm">{item?.subOrganizationName}</div>
                                                    </div>
                                                ...
                                                <ul className="flex flex-col pr-4">
                                                    {item.machines?.map(
                                                        (machine, index) => (
                                                            <li className="flex justify-between  items-center px-2 py-1 border-b border-b-1 border-solid  border-borderGray">
                                                                <div className="gap-3 flex items-center">
                                                                    ...
                                                                    <span className="table-cell text-sm   text-gray70 whitespace-nowrap ">{machine?.type}</span>
                                                                </div>
                                                                <div>
