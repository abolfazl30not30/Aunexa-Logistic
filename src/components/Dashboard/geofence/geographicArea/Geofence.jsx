                                    ...
                                    <li className="py-2 border-b border-1 border-[#D9D9D9] flex justify-between items-center text-[0.9rem] text-[#797979]">
                                        ...
                                        <div className="flex item-center">
                                            <button className="rounded-full hover:bg-neutral-100 p-2">
                                                <svg width="19" height="20" viewBox="0 0 15 16" fill="none"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                            ...
                                            <button className="rounded-full hover:bg-neutral-100 p-2">
                                                <svg width="21" height="22" viewBox="0 0 15 16" fill="none"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        ...
                                                        stroke="#797979" stroke-width="0.5" stroke-linecap="round"/>
                                                </svg>
                                            </button>
                                            <button className="rounded-full hover:bg-neutral-100 p-2" onClick={() => {handleOpenDelete(geofence.id);}}>
                                                <svg width="15" height="17" viewBox="0 0 9 11" fill="none"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <path
