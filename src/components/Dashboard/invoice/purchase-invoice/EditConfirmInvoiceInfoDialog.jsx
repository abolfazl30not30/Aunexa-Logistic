...
export default function EditConfirmInvoiceInfoDialog(props) {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (invoice,helpers) => {
            let updateProduct = {...props.editConfirmInvoiceInfoTarget}
            let failureReason = {
            ...
            handleReset()
            props.handleCloseEditConfirmInvoiceInfo()
        },
    });
                ...
                <DialogContent>
                    <DialogContentText style={{fontFamily: "__fonts_2f4189,__fonts_Fallback_2f4189"}}>
                        <div className="flex justify-end">
                            <button onClick={()=>{props.handleCloseEditConfirmInvoiceInfo();handleReset()}}>
                        ...
                        <form className="flex justify-center " onSubmit={formik.handleSubmit} method="POST">
                            <div className="flex flex-col justify-center w-[90%] gap-5">
                                ...
                                <div className="flex justify-between gap-3">
                                    <button onClick={props.handleCloseEditConfirmInvoiceInfo}
