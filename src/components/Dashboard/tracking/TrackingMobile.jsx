    ...
    return (
        <div>
            <header className="flex justify-between items-center text-[0.9rem] bg-white py-6 px-5 md:px-10">
                ...
                <div className="">
                    <button className="flex  text-white items-center bg-mainPurple border px-3 py-2 rounded-full md:rounded"
