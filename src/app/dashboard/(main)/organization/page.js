...
import AddOrganizationDialog from "@/components/Dashboard/register-organization/AddOrganizationDialog";
import AddSubOrganizationDialog from "@/components/Dashboard/register-organization/AddSubOrganizationDialog";
import EditSubOrganizationInfoDialog from "@/components/Dashboard/register-organization/EditSubOrganizationInfoDialog";
import DeleteSubOrganizationDialog from "@/components/Dashboard/register-organization/DeleteSubOrganizationDialog";
import AddIndividualDialog from "@/components/Dashboard/register-organization/AddIndividualDialog";
import EditIndividualDialog from "@/components/Dashboard/register-organization/EditIndividualDialog";
import DeleteIndividualDialog from "@/components/Dashboard/register-organization/DeleteIndividualDialog";
import MoreIndividualInfoDialog from "@/components/Dashboard/register-organization/MoreIndividualInfoDialog";
import Link from "next/link";
import { useGetAllOrganizationQuery } from "@/redux/features/organization/OrganizationSlice";
import { useSelector } from "react-redux";
import RegisterUserDialog from "@/components/Dashboard/register-organization/RegisterUserDialog";
import UnregisterUserDialog from "@/components/Dashboard/register-organization/UnregisterUserDialog";
    ...
    <div>
      {showPage === "organ" && (
        <header className="flex justify-between items-center text-[0.9rem] bg-white py-6 lg:px-10 px-4">
          ...
          <div className="w-full md:w-[50%]   xl:flex hidden">
            <div className="grow">
          ...
          <div className="">
            {
              <button
                className="flex bg-mainRed text-white items-center text- px-3 py-2 rounded"
      ...
      {showPage === "organ" && (
        <div className="flex justify-center items-center mt-4 text-[0.9rem] bg-white py-6 px-10 xl:hidden">
          <div className="w-full lg:w-[70%] sm:w-[90%]   flex">
            <div className="grow">
              <FormControl fullWidth>
                <OutlinedInput
                  value={searchValue}
            ...
            {showPage === "organ" && (
              <div className="flex justify-between items-center text-[0.9rem] bg-white py-4 mt-4 lg:px-10 px-4">
                ...
                <div className="">
                  {
                    <button
                      className="flex text-mainRed bg-white border border-mainRed items-center text- px-3 py-2 rounded"
                      onClick={() => {
                                    ...
                                    <div className="flex justify-between  items-center ">
                                      ...
                                      <div className="hidden sm:table-cell px-6    whitespace-nowrap ">
                                        <div>
                                          ...
                                          >
                                            <span className="hidden sm:inline md:hidden lg:inline xl:hidden 2xl:inline md:text-base text-[0.7rem] font-bold md:font-normal text-gray9F">
                                              ثبت افراد
                                            </span>
                                            <svg
                                              xmlns="http://www.w3.org/2000/svg"
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      >
                                        <g clip-path="url(#clip0_197_250)">
                                          <path
                                            d="M7.3335 2.66666H4.5335C3.41339 2.66666 2.85334 2.66666 2.42552 2.88464C2.04919 3.07639 1.74323 3.38235 1.55148 3.75867C1.3335 4.1865 1.3335 4.74655 1.3335 5.86666V11.4667C1.3335 12.5868 1.3335 13.1468 1.55148 13.5746C1.74323 13.951 2.04919 14.2569 2.42552 14.4487C2.85334 14.6667 3.41339 14.6667 4.5335 14.6667H10.1335C11.2536 14.6667 11.8137 14.6667 12.2415 14.4487C12.6178 14.2569 12.9238 13.951 13.1155 13.5746C13.3335 13.1468 13.3335 12.5868 13.3335 11.4667V8.66666M5.33348 10.6667H6.44984C6.77596 10.6667 6.93902 10.6667 7.09247 10.6298C7.22852 10.5972 7.35858 10.5433 7.47788 12702C7.61243 10.3877 7.72773 10.2724 7.95833 10.0418L14.3335 3.66666C14.8858 3.11437 14.8858 2.21894 14.3335 1.66666C13.7812 1.11437 12.8858 1.11437 12.3335 1.66665L5.95832 8.04182C5.72772 8.27242 5.61241 8.38772 5.52996 8.52228C5.45685 8.64157 5.40298 8.77163 5.37032 8.90768C5.33348 9.06113 5.33348 9.22419 5.33348 9.55031V10.6667Z"
                                            stroke="#2492FF"
                                            stroke-linecap="round"
                                            stroke-linejoin="round"
                                          />
