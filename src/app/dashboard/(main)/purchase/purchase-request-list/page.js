...
import ConfirmDialog from "@/components/Dashboard/purchase/purchase-request-list/ConfirmDialog";
import { useGetAllPurchaseRequestListQuery } from "@/redux/features/purchase/purchase-request-list/PurchaseRequestListSlice";
import MoreInfoDialog from "@/components/Dashboard/purchase/purchase-request-list/MoreInfoDialog";
import FilterDialog from "@/components/Dashboard/purchase/purchase-request-list/FilterDialog";
import RejectionDialog from "@/components/Dashboard/purchase/purchase-request-list/RejectionDialog";
                  ...
                  {isDataLoading
                    ...
                    : inventoryData?.content?.map((data, index) => (
                        ...
                        >
                          ...
                          <td className="px-2 md:px-6 py-4 space-x-2 text-gray70 whitespace-nowrap ">
